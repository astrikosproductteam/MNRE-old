...
const StyledWrapper = styled.div`
  ...
  /* Fix for overlapping popups - Higher z-index for KPI card popups */
  .kpi-popup-overlay {
...
const stateBasedData = {
  ...
  "Rajasthan": {
    ...
    cities: ["Jaipur", "Jodhour", "Kota", "Bikaner"],
    alerts: [
...
// Enhanced Detail Panel Component with higher z-index
const DetailPanel: React.FC<PanelProps> = ({ isOpen, onClose, title, data, value, unit, color, icon, selectedState }) => {
  if (!isOpen) return null;

  return (
    <StyledWrapper>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm kpi-popup-overlay flex items-center justify-center p-4">
...
export default function KPIDashboard() {
  ...
  return (
    <StyledWrapper>
      ...
      <div className="dashboard-container w-full min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-3 compact-spacing">
        {/* Header */}
